// import { BgStar, Category, Polygon, StarCoord, StarData, Point } from "./journey-star-types";
...
// export function drawBackground(corner: Point, fillColour: string) {
